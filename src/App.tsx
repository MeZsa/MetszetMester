...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-bg text-ink">
      {/* Sidebar */}
      <aside className="w-full md:w-80 border-r border-line bg-white/50 backdrop-blur-md p-6 flex flex-col gap-8">
        ...
        <nav className="flex flex-col gap-4">
          ...
          <button 
            ...
            className="flex items-center gap-3 text-sm font-medium hover:text-accent transition-all group"
          >
            ...
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <button
                  ...
                  className="w-full group flex items-center gap-3 p-2 rounded-xl hover:bg-white hover:shadow-sm transition-all border border-transparent hover:border-line text-left"
                >
      ...
      {/* Main Content */}
      <main className="flex-1 p-6 md:p-12 overflow-y-auto bg-grid relative">
        <div className="max-w-4xl mx-auto">
          {!image ? (
            ...
            >
              <h2 className="text-4xl md:text-6xl font-serif font-light mb-6 tracking-tight text-primary">
              ...
              <div 
                ...
                className="group relative glass-card p-16 transition-all hover:shadow-[0_20px_50px_rgba(26,54,93,0.1)] cursor-pointer border-2 border-dashed border-line hover:border-accent/30"
              >
                <input 
                  type="file" 
                  ref={fileInputRef} 
                ...
                <div className="flex flex-col items-center gap-6">
                  <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-soft-blue to-white flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_10px_20px_rgba(0,0,0,0.05)]">
                    <Upload size={32} className="text-accent opacity-40 group-hover:opacity-100 transition-opacity" />
                  </div>
                  <div className="space-y-1">
                    <p className="text-xl font-medium text-accent">Húzza ide a képet vagy kattintson</p>
            ...
            <div className="space-y-12 pb-20">
              <div className="flex items-center justify-between">
                <button 
                  onClick={clearCurrent}
                  className="flex items-center gap-2 text-sm font-mono uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity text-accent"
                >
                  <X size={16} />
                  Vissza a kezdőlapra
                </button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                >
                  <div className="aspect-square rounded-[2.5rem] overflow-hidden border border-line bg-white shadow-2xl p-4">
                    <img 
                      src={image} 
                      alt="Metszet" 
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-gradient-to-br from-accent to-accent/90 text-white p-5 rounded-3xl shadow-2xl flex items-center gap-3">
                    <div className="p-2 bg-white/20 rounded-xl">
                      <Microscope size={20} />
                    </div>
                    <span className="text-xs font-mono uppercase tracking-widest font-bold">Aktív elemzés</span>
                  </div>
                </motion.div>
                  ...
                  {isAnalyzing ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-6 text-center glass-card">
                      ...
                      <div className="space-y-2">
                        <p className="text-xl font-serif italic text-accent">Metszet elemzése folyamatban...</p>
                        <p className="text-xs font-mono opacity-40 uppercase tracking-widest">Struktúrák azonosítása • Szöveti típus meghatározása</p>
                      </div>
                    </div>
                  ) : error ? (
                    <div className="p-8 bg-red-50 border border-red-100 rounded-3xl text-red-600 shadow-sm">
                    ...
                    <motion.div 
                      ...
                      className="markdown-body glass-card p-8 md:p-10"
                    >
